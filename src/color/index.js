...
function demo5() {
    let canvas = document.querySelector('#demo5')
    let ctx = canvas.getContext('2d')
 ...
 */
function demo8() {
    let canvas = document.querySelector('#demo8')
    let ctx = canvas.getContext('2d')
    let offset = 0
...
function demo9() {
    let canvas = document.querySelector('#demo9')
    let ctx = canvas.getContext('2d')
...
function demo10() {
    let ctx = document.getElementById('demo10').getContext('2d')
...
function demo11() {
    let ctx = document.getElementById('demo11').getContext('2d')
...
function demo12() {
    let ctx = document.getElementById('demo12').getContext('2d')
