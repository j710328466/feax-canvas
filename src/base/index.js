 ...
 */
function fillRect() {
    let canvas = document.querySelector('#fillRect')
...
// 绘制三角形
function tri() {
    let canvas = document.querySelector('#tri')
    let ctx = canvas.getContext('2d')
...
// 绘制圆弧
function drawArc() {
    let canvas = document.querySelector('#arc')
    let ctx = canvas.getContext('2d')
 ...
 */
function bezier() {
    let canvas = document.querySelector('#bezier')
    let ctx = canvas.getContext('2d')
 ...
 */
function beziers() {
    let canvas = document.querySelector('#beziers')
    let ctx = canvas.getContext('2d')
 ...
 */
function fillSmile() {
    let canvas = document.querySelector('#fillSmile')
    let ctx = canvas.getContext('2d')
 ...
 */
function bean() {
    let canvas = document.querySelector('#bean')
    let ctx = canvas.getContext('2d')
